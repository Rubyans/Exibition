...
<html>
        ...
        <form action="exhibition?command=adminauthor"  id="AuthorForm" class="AuthorForm" method="POST">
            ...
            <div id="addDiv" style="display: none;">
                <div class="wrapper">
                    <div class="left_block">
                        <input type="text" id="InputFirstNameAd" placeholder="${languageChange.get(17)}" name="firstNameAuthor" >
                        <br><input type="text" id="InputLastNameAd" placeholder="${languageChange.get(18)}" name="lastNameAuthor" >
                        <br><input type="email" id="InputEmailAd" placeholder="${languageChange.get(19)}" name="emailAuthor" >
                    </div>
                    <div class="buttonAdd">
                        <button class="addButtonServlet" id="addButtonAuthor" name="addButtonAuthor">${languageChange.get(20)}</button>
                    </div>
                </div>
            </div>
            ...
            <div class="delDiv" id="delDiv" style="display: none;">
                    <div class="InputDelDiv">
                        <input class="inputDel" type="email" id="InputDelAuthor" placeholder="${languageChange.get(19)}" name="authorDel">
                    </div>
                    <button class="delButtonServlet" id="delButtonAuthor" name="delButtonAuthor">${languageChange.get(21)}</button>
            </div>

            <table id="myTable">
                <tr>
                    <th id="firstName">${languageChange.get(22)}</th>
                    <th id="lastName">${languageChange.get(23)}</th>
                    <th id="email">${languageChange.get(24)}</th>
                </tr>
                ...
                <c:if test="${requestScope.Error}">
                    <script>
                        sweetAlert("${languageChange.get(25)}", "${languageChange.get(26)}", "error");
                    </script>
                </c:if>
            </table>
    ...
    <script src="./JS/adminJS/fourthPage/AdminFourthMenu1.js" type="text/javascript"></script>
    </body>
</html>